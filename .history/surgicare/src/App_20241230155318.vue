    ...
    <div class="content-wrapper">
      <aside class="sidebar">
        ...
        <nav class="menu">
          ...
          <router-link to="/member" class="menu-item">Member</router-link>
          <router-link to="/wound-assessment" class="menu-item">Wound Assessment</router-link>
        </nav>
      </aside>
...
.content-wrapper {
  display: flex;
  flex: 1;
  margin-top: 70px; /* Offset for the header */
}
...
.router-view {
  height: 100vh; /* ใช้เต็มความสูง */
  width: 100vw; /* ใช้เต็มความกว้าง */
  margin: 0;
  padding: 0;
  overflow: hidden;
}
