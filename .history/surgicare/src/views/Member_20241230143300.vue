      ...
      members: [
        {
          ...
          role: "Founder",
          photo: "Pogus.jpg",
          bio: "Founder of Surgicare.",
        },
        {
          name: "Thanayot Monthichachat",
          role: "Co-founder",
          photo: "Zoe.jpg",
          bio: "Co-founder of Surgicare.",
        },
        {
...
.member-cards {
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); /* Resize dynamically */
  gap: 20px;
  max-width: 960px; /* Limit total width */
  width: 100%;
}
