...
#team-page {
  ...
  align-items: center;
  position: relative; /* Ensure proper boundary control */
}

.team-header {
  margin-bottom: 30px;
  text-align: center;
  padding: 60px 20px; /* Expand top padding for a broader look */
  background-color: #e0f7f4; /* Add a subtle contrasting color */
  border-bottom: 4px solid #42b983;
  width: 100%;
  max-width: 1200px; /* Keep it within page bounds */
}
...
.member-card-container {
  ...
  width: 100%;
  max-width: 600px;
  margin-bottom: 30px; /* Prevent container from overflowing */
}
...
/* Background control for the entire page */
html, body {
  overflow-x: hidden; /* Prevent horizontal scroll due to background overflow */
}
</style>
