...
/* Base Styles */
#team-page {
  padding: 20px 20px; /* Reduce padding at the top */
...
.team-header {
  margin-bottom: 20px; /* Reduce margin between header and cards */
  text-align: center;
  padding: 40px 20px; /* Reduce padding to bring it closer to the top */
